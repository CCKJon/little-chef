<script>
	...
	/**
	 * @type {{ temp_c: any; condition: { text: any; }; humidity: any; } | null}
	 */
...
{#if weatherData && userLocation}
	<div
		class="text-orange-300 w-[200px] bg-orange-300/10 shadow-2xl shadow-orange-300/20 text-center flex flex-col gap-1 p-4 border border-x-4 border-y-2 border-orange-300 rounded-r-3xl rounded-bl-3xl"
	>
		<div
			class="font-bold border-l-2 border-b-4 border border-orange-200 px-2 bg-black/90 rounded-tr-2xl"
		>
			<div class="underline">Location:</div>
			<div>{userLocation.name}</div>
			{console.log(userLocation.name)}
		</div>
		<div class="font-bold border-l-2 border-b-4 border border-orange-200 px-2 bg-black/90">
		...
		<div
			class="font-bold border-l-2 border-b-4 border border-orange-200 px-2 bg-black/90 rounded-br-2xl"
		>
